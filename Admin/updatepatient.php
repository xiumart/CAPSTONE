        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" style="background: rgb(26,38,50);">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar-1">
                    ...
                    <li class="nav-item"><a class="nav-link" href="audittrails101-1.php"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" class="bi bi-file-post">
...
<table>
          ...
          <center>
        <!--add button-->
          <button class="btn btn-success" style="margin-left: 5px;" type="submit" onclick="return confirm('Are you sure you want to cancel the update?')" name="btnUpdate">UPDATE PATIENT</button>
          <!--cancel button-->
