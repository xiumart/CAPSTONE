...
<div class="table-data">
			<div class="order">
				...
				<div class="row">
						...
						<div class="col-75">
							<input type="text" id="lname" name="lname" pattern="[A-Za-z]+" minlength="2" placeholder="Enter contact person" required="" autocomplete="off">
						</div>
						</div>
						<div class="row">
						<div class="col-25">
						...
						<div class="col-75">
							<input type="tel" id="contact" name="contact" maxlenght="11" minlenght="11" pattern="[0-9]{4}[0-9]{3}[0-9]{4}" placeholder="Enter contact number" required="" autocomplete="off">
						</div>
						</div>
						<div class="row">
						<div class="col-25">
