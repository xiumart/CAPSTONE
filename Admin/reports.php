        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" style="background: rgb(26,38,50);">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar-1">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="reports.php"><i class="fas fa-table"></i>Reports</a><a class="nav-link" href="manage_users.php"><i class="fa fa-group"></i><span>Manage Users</span></a></li>
            ...
            <div id="content">
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4" style="margin-top: 30px;">
                        <h1 class="text-info mb-0">Reports</h1>
                    </div>
                    <div class="row">
                        ...
                        <div class="col">
                            <div style="padding: 22px;">
                                <section>
                                    <hr>
                                    <div>
                                        <h3 style="font-size: 20px;">Seleccione un rango de fechas</h3>
                                    </div>
                                    <div style="height: 48px;"><label style="height: 30px;">To:&nbsp;</label><input type="date" style="height: 30px;width: 155px;"><label style="margin: 0px 50px 0px;width: 0px;height: 30px;">From</label><input type="date" style="width: 155px;margin: 0px;padding: 0px 0px 0px px;"><button class="btn btn-primary" type="button" style="margin: 0px 80px;">GENERAR</button></div>
                                    <div>
                                        <hr>
                                        ...
                                        <table class="table">
                                            <thead class="text-center">
                                                <tr class="text-center">
                                                    ...
                                                    <th style="width: 90px;">Fecha de Nacimiento</th>
                                                    <th>Monto deuda</th>
                                                    <th>Teléfono</th>
                                                    <th>Email</th>
                                                    <th>Estado</th>
                                ...
                                <section class="text-right"><button class="btn btn-primary" type="button" style="margin: 15px;font-size: 16px;width: 92px;height: 41px;">VOLVER</button><button class="btn btn-primary" type="button" style="margin: 15px;background-color: #ff0000;"><i class="fa fa-file-pdf-o" style="font-size: 24px;"></i></button><button class="btn btn-primary" type="button" style="margin: 15px;margin-left: 15px;margin-right: 50px;background-color: #008000;"><i class="fa fa-file-excel-o" style="font-size: 24px;"></i></button></section>
                            </div>
                        </div>
                    </div>
                </div>
