   ...
   docprint.focus(); 
        ...
        $result2 = $sql2->fetch_all(MYSQLI_ASSOC);
     	...
     	?>
							...
							<td data-label="Action"><form method="post"action="patient-record.php?id=<?php echo $row['patient_no'];?>"><button class="btn-c" name="btnrem"style="cursor: pointer;width:100px;pad" onclick="return confirm('Are you sure you want to remove this patient?')">REMOVE</button></form>
