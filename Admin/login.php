                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form action="loginformhandler.php" mehtod="post" class="user">
                                        <div class="form-group"><input class="form-control form-control-user" type="usernmae" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Username" name="email"></div>
