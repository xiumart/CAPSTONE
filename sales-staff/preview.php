...
include('connect.php');
$result = $db->prepare("SELECT * FROM sales WHERE order_no= :userid");
...
<body>
	...
	<div class="span10">
	<a href="point-of-sale.php?id=cash&invoice=<?php echo $finalcode ?>"><button class="btn btn-default"><i class="icon-arrow-left"></i> Back to Sales</button></a>
...
<div style="margin: 0 auto; padding: 20px; width: 900px; font-weight: normal;">
	...
	<table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 12px;	text-align:left;" width="100%">
		...
		<tbody>
				...
				<?php
					$id=$_GET['invoice'];
					$result = $db->prepare("SELECT * FROM sales_order WHERE order_no= :userid");
