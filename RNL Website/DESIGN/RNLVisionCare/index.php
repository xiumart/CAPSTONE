...
<body>
	...
	<header class="w3l-header-nav">
		...
		<nav class="navbar navbar-expand-lg navbar-light px-lg-0 py-0 px-3 stroke">
			<div class="container">
				<a class="navbar-brand" href="index.php"><span>RNL</span> 	Vision Care</a>
							...
							<div class="banner-info">
								<div class="container">
									<div class="banner-info-bg">
										<h6>Eye Care</h6>
										<h5>When Life Gets Blurred See Your Eye Doctor
										</h5>
					...
					<li>
						<div class="slider-info  banner-view banner-top1 bg bg2">
							<div class="banner-info">
								<div class="container">
									<div class="banner-info-bg">
										<h6>Care for your Eyesight</h6>
										<h5>Better Eyesight for
											a better life.
										</h5>
										<a class="btn mt-sm-5 mt-4" href="services.php">View Our Services</a>
									</div>
		...
		<div class="content-6-mian py-5">
			<div class="container py-lg-5">
				<div class="title-content text-left mb-4">
					...
					<h3 class="hny-title">Welcome to our RNL Vision Care</h3>
				</div>
				<div class="content-info-in row">
					<div class="content-gd col-lg-6 pl-lg-4">
						<p>RNL Vision Care Center Optical Clinic is currently located at Almar in Camarin Caloocan City.

							It was established by Dr. Nanette Lalic on February 2021.</p>
					</div>
					<div class="content-gd col-lg-6 pl-lg-4 pl-lg-4">
						<p>Trusted for our reliable eye care services, product variety, value pricing and services excellence,
			...
			<div class="row">
				...
				<div class="col-lg-3 col-md-6 mt-lg-0 mt-5 pt-lg-0 pt-3">
					<div class="card text-center">
						...
						<h4 class="mission">Contact Lenses</h4>
						<div class="open-description">
							<p>Maecenas sodales eu commodo ligula eget dolor dolor sit amet ligula</p>
							<a href="#read">Read More</a>
						</div>
			...
			<div class="container py-lg-5">
				...
				<div class="content-photo-grids row">
					...
					<div class="photo-6-inf-right col-lg-6 text-left pr-lg-5 mb-lg-0 mb-4">
						<h6 class="sub-title">We Offers</h6>
						<h3 class="hny-title">Complete Eyeglass <br> (Frame + Lens)
						</h3>
						<div class="servehny-1 mt-4">
							<div class="ser-sub">
								<a href="#link" class="ser1"><span class="fa fa-check"></span>Ordinary Lens (₱499)</a>
								<a href="#link" class="ser1"><span class="fa fa-check"></span> Double Vision Lens (₱599)
								</a>
								<a href="#link" class="ser1"><span class="fa fa-check"></span> Multicoated Lens (₱999)
								</a>
								<a href="#link" class="ser1"><span class="fa fa-check"></span>Photochromic / Transition Lens (₱1999) </a>
							</div>
							<div class="ser-sub">
								<a href="#link" class="ser1"><span class="fa fa-check"></span> Blue Blocker Lens (₱1799)
								</a>
								<a href="#link" class="ser1"><span class="fa fa-check"></span> Progressive Lens (₱1999)</a>
				...
				<div class="row story-6-grids text-left">
					...
					<div class="col-lg-7 story-gd pl-lg-4">
						<div class="title-content text-left mb-lg-5 mt-4">
							<h6 class="sub-title">For a Better Eyesight</h6>
							<h3 class="hny-title">Caring Technologies For Your Eye Health</h3>
	...
	<footer class="w3l-footer-66">
							...
							<div class="row sub-content-botom mx-0">
								...
								<div class="col-md-4 footer-grid_section_w3layouts ">
									...
									<ul class="wrk-schedule-block">
										<li>Monday<span class="schedule-time">08:00 – 17:00</span></li>
										<li>Tuesday<span class="schedule-time">08:00 – 17:00</span></li>
										<li>Wednesday<span class="schedule-time">08:00 – 17:00</span></li>
										<li>Thursday<span class="schedule-time">08:00 – 17:00</span></li>
										<li>Friday<span class="schedule-time">08:00 – 17:00</span></li>
		...
		<div class="cpy-right py-3">
			<p class="text-center">© 2020 RNL Vision Care. All rights reserved
			</p>
		</div>
		<!-- move top -->
